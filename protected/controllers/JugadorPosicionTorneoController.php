...
class JugadorPosicionTorneoController extends Controller
{
...
array('allow',
	'actions'=>array('ObtenerPosicionesTorneo'),
	'users'=>array('*'),
),
array('deny',
	'users'=>array('*'),
...
{
$model=new JugadorPosicionTorneo;
$user = Yii::app()->user;
...
if(isset($_POST['JugadorPosicionTorneo']))
{
$model->attributes=$_POST['JugadorPosicionTorneo'];
if($model->save()){
...
{
$dataProvider=new CActiveDataProvider('JugadorPosicionTorneo');
...
{
$model=new JugadorPosicionTorneo('search');
$model->unsetAttributes();  // clear any default values
if(isset($_GET['JugadorPosicionTorneo']))
$model->attributes=$_GET['JugadorPosicionTorneo'];
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='jugador-posicion-torneo-form')
{
