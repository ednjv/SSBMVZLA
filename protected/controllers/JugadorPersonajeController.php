...
class JugadorPersonajeController extends Controller
{
...
{
$dataProvider=new CActiveDataProvider('JugadorPersonaje');
...
{
$model=new JugadorPersonaje('search');
$model->unsetAttributes();  // clear any default values
if(isset($_GET['JugadorPersonaje']))
$model->attributes=$_GET['JugadorPersonaje'];
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='jugador-personaje-form')
{
