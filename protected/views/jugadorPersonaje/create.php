...
$this->breadcrumbs=array(
	'Jugador Personajes'=>array('admin'),
	'Nuevo registro',
);
...
<?php $this->Widget('booster.widgets.TbPanel', array(
    ...
    'content' => $this->renderPartial('_form',array('model'=>$model,'selectJugadores'=>$selectJugadores,'selectPersonajes'=>$selectPersonajes),true,false),
        ));
?>
