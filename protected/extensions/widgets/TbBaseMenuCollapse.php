 ...
 */
abstract class TbBaseMenuCollapse extends CMenu {
	/**
	 *### .getDividerCssClass()
	 *
				...
				if (isset($item['divider'])) {
					...
					if (isset($item['items']) && !empty($item['items'])) {
						...
						if (isset($item['submenuOptions']['class'])) {
							$item['submenuOptions']['class'] .= ' collapse';
						} else {
							$item['submenuOptions']['class'] = 'collapse';
						}
						...
						$dropdownOptions['id'] = isset($dropdownOptions['htmlOptions']['id']) ? $dropdownOptions['htmlOptions']['id'] : $item['label']; //isset($dropdownOptions['htmlOptions']['id']) ? $dropdownOptions['htmlOptions']['id'] : null;
						$this->controller->widget('application.extensions.widgets.TbMenuCollapse', $dropdownOptions);
					}
	...
	protected function renderMenuItem($item) {
		...
		if (isset($item['items']) && !empty($item['items'])) {
			if (empty($item['url'])) {
				if(isset($item['submenuOptions']['id'])){
					$item['url'] = '#'.$item['submenuOptions']['id'];
				}else{
					$item['url'] = '#'.$label;
				}
			}
			...
			*/
			...
			$item['label'] .= ' <span class="caret caretright"></span>';
		}
